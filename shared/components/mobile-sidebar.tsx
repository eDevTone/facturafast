        ...
        <div className="flex h-full flex-col">
          ...
          <SheetHeader className="border-b p-6">
            <SheetTitle className="text-left">
              ...
              >
                ...
                <span className="text-lg font-bold">FacturaFast</span>
              </Link>
            </SheetTitle>
          </SheetHeader>
          ...
          >
            ...
            <div className="pt-4">
              ...
              <NavItem href="/facturas" icon={Receipt} label="Facturas" />
              <NavItem href="/cotizaciones" icon={FileText} label="Cotizaciones" />
              <NavItem href="/notas-credito" icon={CreditCard} label="Notas de Crédito" />
            </div>
